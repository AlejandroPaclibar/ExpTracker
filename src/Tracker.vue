...
<template>
  <div class="adjust justify-center items-center h-full">
    <div>
      <h1 class="title text-center m-5 text-3xl font-bold">Expense Tracker</h1>

      <div class="adjust1 flex flex-col justify-center mx-auto md:flex-row ">
        <div
          class="left lg:w-1/3 m-3 p-3 border border-slate-500 rounded"
          style="height: 450px"
        >
          <form
          ...
          >
            ...
            <input
              type="text"
              v-model="name"
              class="border border-slate-500 rounded text-black mb-5 p-2"
            />

            <label for="category" class="my-5">Category: </label>
            <select
              v-model="category"
              class="mb-5 border border-slate-500 text-black rounded p-2"
            >
            ...
            <input
              type="number"
              v-model="amount"
              class="border border-slate-500 text-black rounded mb-5 p-2"
            />
            <button
              type="submit"
              class="border-2 py-2 rounded text-white hover:opacity-80 hover:border-black hover:text-black hover:bg-white transition ease-linear duration-100"
            >
              {{ buttonText }}
            </button>
          </form>
        ...
        <div class="center lg:w-2/3 m-3" style="max-height: 450px; width: 100%">
          <div>
            <table class="scrolldown ">
              <thead>
                <tr>
                  ...
                  <th class="px-3 py-2 border">Edit</th>
                </tr>
              </thead>
              <tbody    >
...
.center{
  ...
  table.scrolldown thead th {
    ...
    text-align: left;
    color: #1a237e; /* Change to your preferred color */
  }
